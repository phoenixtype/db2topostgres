...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8758302028998232693L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"dev.phoenixtype.db2topostgres.model\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public static dev.phoenixtype.db2topostgres.model.Student.Builder newBuilder() {
    return new dev.phoenixtype.db2topostgres.model.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static dev.phoenixtype.db2topostgres.model.Student.Builder newBuilder(dev.phoenixtype.db2topostgres.model.Student.Builder other) {
    if (other == null) {
      return new dev.phoenixtype.db2topostgres.model.Student.Builder();
    } else {
      return new dev.phoenixtype.db2topostgres.model.Student.Builder(other);
    }
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static dev.phoenixtype.db2topostgres.model.Student.Builder newBuilder(dev.phoenixtype.db2topostgres.model.Student other) {
    if (other == null) {
      return new dev.phoenixtype.db2topostgres.model.Student.Builder();
    } else {
      return new dev.phoenixtype.db2topostgres.model.Student.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dev.phoenixtype.db2topostgres.model.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dev.phoenixtype.db2topostgres.model.Student other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.phoenixtype.db2topostgres.model.Student.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.phoenixtype.db2topostgres.model.Student.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.phoenixtype.db2topostgres.model.Student.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.phoenixtype.db2topostgres.model.Student.Builder clearName() {
      name = null;
